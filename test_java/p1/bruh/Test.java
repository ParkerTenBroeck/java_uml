...
public class Test<T extends Object> implements Function {
    ...
    public static void test(List<? extends Function<? extends boolean[], Object>> test, ArrayList<? extends Comparator> test2){

    }

    protected static native synchronized final void help();
    protected static synchronized strictfp short test(){ return 0; }
    public static volatile transient long Long = 0;
    public static final char hell = '\0';
